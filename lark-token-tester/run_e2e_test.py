...
# Cloud Function URL - this needs to be updated with actual deployed URL
# For testing purposes, we'll use a mock approach since we can't access the actual deployed function
