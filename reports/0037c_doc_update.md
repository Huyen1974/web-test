...
- Kết thúc: branch `main`, HEAD = origin/main (sau commit doc update), working tree sạch.
...
- Commit doc update sẽ kích hoạt lại CI (Nuxt build, Pass Gate, Quality Gate, E2E, Terraform Deploy); kỳ vọng xanh vì chỉ thay đổi tài liệu.
