...
from scripts.preflight_check import main as preflight_main, preflight_check
...
def test_preflight_success(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setenv("GCP_WIF_PROVIDER", "projects/123/locations/global/workloadIdentityPools/pool/providers/provider")
