...
| E1-06-AGENT-CONNECT-V12 | E1 | Kết nối Agent Data V12 & test E2E | Bắt buộc search trước draft | Webhook Directus → FastAPI `/ingest`; bắt buộc `/search` Qdrant trước draft (conflict >0.8 auto-comment); test 1-click Nuxt → Flow → Pub/Sub → Langroid → Revisions trace. | TODO |
