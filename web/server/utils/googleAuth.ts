 ...
 *
 * DEPRECATED: Cloud Run auth commented out in P19 (2026-02-14).
 * All services migrated to VPS since 2026-02-13.
 * Kept for reference — VPS uses API key auth via agentDataAuth.ts.
 *
...
// Stub exports for import compatibility (P19)
export async function getIdentityToken(_targetAudience: string): Promise<string> {
	throw new Error('Cloud Run auth deprecated — all services on VPS since 2026-02-13');
}
